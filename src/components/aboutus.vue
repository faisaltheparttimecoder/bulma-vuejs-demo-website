    ...
    <section class="section">
      <div class="content">
        ...
        <p>Lorem ipsum<sup><a>[1]</a></sup> dolor sit amet, consectetur adipiscing elit. Nulla accumsan, metus ultrices
          ...
          erat odio, sollicitudin vel erat vel, interdum mattis neque. Sub<sub>script</sub> works as well!</p>
        <h2>Second level</h2>
        <p>Curabitur accumsan turpis pharetra <strong>augue tincidunt</strong> blandit. Quisque condimentum maximus mi,
          ...
          sem rhoncus lacus dapibus facilisis. Donec at dignissim dui. Ut et neque nisl.</p>
        <ul>
        ...
        <p>Phasellus porttitor enim id metus volutpat ultricies. Ut nisi nunc, blandit sed dapibus at, vestibulum in
          ...
          Nunc ultricies nunc neque, vitae ultricies ex sodales quis. Aliquam eu nibh in libero accumsan pulvinar.
          Nullam nec nisl placerat, pretium metus vel, euismod ipsum. Proin tempor cursus nisl vel condimentum. Nam
    ...
    <footer class="footer">
      <div class="container">
        <div class="content has-text-centered">
          <p>
            A demo website for learning the integration of <a href="https://bulma.io"><strong>Bulma</strong></a>
            and <a href="https://vuejs.org"><strong> VueJS </strong></a>
            and so far its looking pretty awesome.
          </p>
        </div>
      </div>
    </footer>
...
<script>
  ...
  export default {
    data: function() {
      return {
        title: "Believers !!!!",
        subtitle: "Because we believe in the best"
      }
    }
  }
